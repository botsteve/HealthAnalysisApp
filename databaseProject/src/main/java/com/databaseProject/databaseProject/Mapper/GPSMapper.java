...
public class GPSMapper {
    ...
    public static GPSDto fromEntityToDto(GPS gps) {
        return new GPSDto(gps.getLatitude(),gps.getLongitude(),gps.getAltitude(),gps.getTimeValue());
    }

    public static GPS fromDtoToEntity(GPSDto gpsDto) {
        return new GPS(gpsDto.getLatitude(),gpsDto.getLongitude(),gpsDto.getAltitude(),gpsDto.getTimeValue());
    }
}
